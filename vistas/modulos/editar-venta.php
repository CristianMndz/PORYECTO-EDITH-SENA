                  ...
                  <div class="col-xs-6" style="padding-right:0px">
                     ...
                     <div class="input-group">
                      ...
                      <select class="form-control" id="nuevoMetodoPago" name="nuevoMetodoPago" required>
                        ...
                        <option value="TC">Tarjeta Crédito/Débito</option>                 
                      </select>    
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevaDireccion" placeholder="Ingresar dirección de envio" required>
