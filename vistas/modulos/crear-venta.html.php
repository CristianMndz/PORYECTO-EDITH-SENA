      ...
      <div class="col-lg-5 col-xs-12">
        ...
        <div class="box box-success">
          ...
          <div class="box-footer">
            ...
            <button type="submit" class="btn btn-primary pull-right">Crear contrato</button>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" min="0" class="form-control input-lg" name="nuevoDocumentoId" placeholder="Ingresar codigo" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevaDireccion" placeholder="Ingresar dirección de envió" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevaFechaNacimiento" placeholder="Ingresar fecha de registro" data-inputmask="'alias': 'yyyy/mm/dd'" data-mask required>
