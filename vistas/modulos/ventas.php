...
if($xml){
  ...
  echo '<a class="btn btn-block btn-success abrirXML" archivo="xml/'.$_GET["xml"].'.xml" href="ventas">
        Se ha creado correctamente el archivo XML <span class="fa fa-times pull-right"></span></a>';
}
       ...
       <table class="table table-bordered table-striped dt-responsive tablas" width="100%">
        ...
        <?php
          ...
          foreach ($respuesta as $key => $value) {
            ...
            if ($respuestaCliente && isset($respuestaCliente["nombre"])) {
                echo '<td>'.$respuestaCliente["nombre"].'</td>';
            } else {
                echo '<td>No disponible</td>'; // Si no encuentra cliente
            }
            ...
            if ($respuestaUsuario && isset($respuestaUsuario["nombre"])) {
                echo '<td>'.$respuestaUsuario["nombre"].'</td>';
            } else {
                echo '<td>No disponible</td>'; // Si no encuentra usuario
            }
