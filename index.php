      ...
      <div class="container">
        <div class="row">
          <div class="intro-text">
            <h1>Bogotá</h1>
            <h1>Food</h1>
            <p>Reservaciones: (304) 300-5451</p>
          </div>
        </div>
      </div>
    </div>
    ...
    ?>
      <div class="col-xs-12 col-sm-4">
        <div class="features-item">
          ...
          ?>
          <p> Precio del Menú: $<?php echo $rowPlatillos["precio_venta"]; ?> </p>
        </div>
      </div>
      <?php
          } // end while platillos
    ...
    <div class="section-title">
      ...
      <br>
        ...
        ?>
                ...
                <h5>NOTA: Cada platillo corresponde al tipo de banquete que se muestra en la siguiente tabla y el precio de producto varia de acuerdo a los demás menú´s que se muestran arriba</h5>
                </div>
                <div class="row">
                  <style>
                      table {
  ...
  <div class="container text-center">
    ...
    <div class="col-md-4">
      ...
      <div class="contact-item">
        ...
        <p>Sabado-Domingo: 11:00 AM - 09:00 PM</p>
      </div>
    </div>
  </div>
  <div class="container">
...
<div id="footer">
  <div class="container text-center">
    <div class="col-md-6">
      <p>&copy; 2024 EDITH - Proyecto SENA. Todos los derechos reservados.</p>
    </div>
    <div class="col-md-6">
      <div class="social">
        <ul>
